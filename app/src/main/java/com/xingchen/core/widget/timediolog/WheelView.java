...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0.2f, 0, 0.2f, 0xFF000000);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.smart_lock_timedialog_wheel_val);
		} 
		...
		setBackgroundResource(R.drawable.smart_lock_timedialog_wheel_bg);
	}
